...
package net.justanothervoiddimension.world.dimension;
...
public class VoidDimensionDimension extends JustAnotherVoidDimensionModElements.ModElement {
	@ObjectHolder("just_another_void_dimension:void_dimension")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public VoidDimensionDimension(JustAnotherVoidDimensionModElements instance) {
		super(instance, 1);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("void_dimension"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("just_another_void_dimension:void_dimension")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("just_another_void_dimension:void_dimension"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("just_another_void_dimension:void_dimension"));
	}
